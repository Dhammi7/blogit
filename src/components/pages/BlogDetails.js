...
const BlogDetails = () => {
  ...
  const postComment = async () => {
    ...
    try {
      const res = await fetch(`https://blogit-backend-mxsw.onrender.com${blogId}/comments`, {
        method: 'POST',
        headers: {
  ...
  const deleteComment = async (comment) => {
    ...
    try {
      const res = await fetch(`https://blogit-backend-mxsw.onrender.com${blogId}/comments/${encodeURIComponent(commentId)}`, {
        method: 'DELETE',
        headers: {
